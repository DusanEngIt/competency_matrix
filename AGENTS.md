...
| **Hybrid search score** | `0.60 × cosine_similarity + 0.25 × ts_rank + 0.15 × recency_score`; min threshold 0.70; 10 results per page |
...
See [Section 17 of the spec](./README.md) — Workday API type and SMTP config are unresolved before implementation.
